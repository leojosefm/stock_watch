...
def process_revision_directives(context, revision, directives):
    """
    Hook to modify the autogenerate process. You can override Alembic's default
    behavior of dropping tables and recreating them by modifying or filtering
    directives.
    """
    script = directives[0]
    for op in script.upgrade_ops.ops:
        if isinstance(op, alembic.operations.ops.DropTableOp):
            # Prevent drop table operations
